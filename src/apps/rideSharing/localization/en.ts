const en = {
  ...
  wallet_refresh: 'Refresh wallet',
  wallet_transactions: 'Transactions',
  wallet_transaction_default_title: 'Transaction',
  wallet_transactions_empty_title: 'No transactions yet',
  wallet_transactions_empty_subtitle: 'Your wallet activity will appear here once you start using it.',
  wallet_tab_all: 'All',
  ...
  wallet_offer_fare_hint: 'Enter an amount between {{minAmount}} and {{maxAmount}}',
  ...
  wallet_add_card_required_hint: 'To enable top-up, add a card first.',
