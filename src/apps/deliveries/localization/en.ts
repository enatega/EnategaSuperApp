const en = {
  ...
  generic_list_map_action: 'Open map view',
  generic_restaurants_title: 'Restaurants',
  ...
  filter_category_pizza: 'Pizza',
  filter_category_burger: 'Burger',
  filter_category_veg: 'Veg',
  filter_category_non_veg: 'Non-veg',
  filter_category_asian: 'Asian',
  filter_category_arabic: 'Arabic',
  filter_category_french: 'French',
  filter_category_chinese: 'Chinese',
  filter_category_african: 'African',
  filter_category_ice_cream: 'Ice cream',
  filter_category_sushi: 'Sushi',
  filter_category_fish: 'Fish',
  filter_category_sandwich: 'Sandwich',
  filter_category_pasta: 'Pasta',
  filter_address_home: 'Home',
  filter_address_home_description: 'Aspire Zone Qatar, Doha, Qatar',
  filter_address_office: 'Office',
  filter_address_office_description: '123 Business Ave, Doha, Qatar',
  filter_sort_recommended: 'Recommended',
  filter_sort_delivery_price: 'Delivery price',
  filter_sort_rating: 'Rating',
  filter_sort_delivery_time: 'Delivery time',
