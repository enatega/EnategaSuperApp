const fr = {
  ...
  filter_open_label: 'Ouvrir les filtres',
  filter_close_label: 'Fermer les filtres',
  filter_apply_results: 'Appliquer',
  ...
  generic_list_back_action: 'Retour',
  ...
  generic_list_map_action: 'Ouvrir la vue carte',
  ...
  filter_category_veg: 'Végé',
  filter_category_non_veg: 'Non-végé',
  filter_category_asian: 'Asiatique',
  filter_category_arabic: 'Arabe',
  filter_category_french: 'Français',
  filter_category_chinese: 'Chinois',
  filter_category_african: 'Africain',
  filter_category_ice_cream: 'Glace',
  filter_category_sushi: 'Sushi',
  filter_category_fish: 'Poisson',
  filter_category_sandwich: 'Sandwich',
  filter_category_pasta: 'Pâtes',
  filter_address_home: 'Maison',
  filter_address_home_description: 'Aspire Zone Qatar, Doha, Qatar',
  filter_address_office: 'Bureau',
  filter_address_office_description: '123 Business Ave, Doha, Qatar',
  filter_sort_recommended: 'Recommandé',
  filter_sort_delivery_price: 'Prix de livraison',
  filter_sort_rating: 'Note',
  filter_sort_delivery_time: 'Temps de livraison',
