const fr = {
  ...
  tos_intro: 'Ces conditions d\'utilisation définissent votre accès et votre utilisation de l\'application de livraison de nourriture.',
  tos_section_usage_title: 'Utilisation du service',
  tos_section_usage_body: 'L\'application de livraison de nourriture fournit une plateforme fiable pour commander et gérer vos livraisons de repas.',
  tos_section_orders_title: 'Gestion des commandes',
  tos_section_orders_body: 'L\'application vous permet de suivre facilement vos commandes, de modifier les détails ou de les annuler dans le délai imparti.',
  tos_section_payment_title: 'Sécurité des paiements',
  tos_section_payment_body: 'Les paiements via l\'application sont traités de manière sécurisée avec une technologie de chiffrement.',
  tos_section_delivery_title: 'Politiques de livraison',
  tos_section_delivery_body: 'Les utilisateurs sont encouragés à fournir des adresses de livraison précises pour faciliter un service rapide et efficace.',
  tos_section_support_title: 'Service client',
  tos_section_support_body: 'L\'application fournit un système d\'assistance robuste pour répondre à toutes les questions ou problèmes.',
  ...
  tou_intro: 'Ces conditions d\'utilisation définissent vos droits et responsabilités lors de l\'utilisation de l\'application.',
  tou_section_guidelines_title: 'Directives d\'utilisation',
  tou_section_guidelines_body: 'L\'application fournit une gestion sécurisée de vos commandes et données client.',
  tou_section_etiquette_title: 'Étiquette de livraison',
  tou_section_etiquette_body: 'Les utilisateurs doivent maintenir le respect et la courtoisie envers le personnel de livraison.',
  tou_section_payment_title: 'Méthodes de paiement',
  tou_section_payment_body: 'L\'application prend en charge plusieurs méthodes de paiement, notamment les cartes de crédit et les portefeuilles numériques.',
  tou_section_cancellation_title: 'Politique d\'annulation',
  tou_section_cancellation_body: 'Les commandes peuvent être annulées dans un délai de 10 minutes après leur passation.',
  tou_section_feedback_title: 'Commentaires et évaluations',
  tou_section_feedback_body: 'Les utilisateurs sont encouragés à donner leur avis sur leur expérience de livraison.',
  tou_section_promotions_title: 'Promotions et offres',
  tou_section_promotions_body: 'L\'application peut proposer des promotions et des réductions soumises à des conditions spécifiques.',
  ...
  privacy_intro: 'Cette politique de confidentialité explique comment nous traitons vos informations personnelles lors de l\'utilisation de l\'application de livraison de nourriture. En vous inscrivant ou en accédant à l\'application, vous consentez aux pratiques décrites dans cette politique.',
  privacy_section_app_title: 'Politique de confidentialité pour l\'application',
  privacy_section_app_body: 'L\'application de livraison de nourriture s\'engage à protéger et gérer vos données personnelles et commandes en toute sécurité. Vous êtes autorisé à utiliser l\'application à des fins personnelles et commerciales, sous réserve de respecter cette politique et toutes les lois applicables.',
  privacy_section_responsibilities_title: 'Responsabilités des utilisateurs',
  privacy_section_responsibilities_body: 'Les utilisateurs sont responsables de l\'exactitude de leurs adresses de livraison et de leurs informations de paiement. Il est important de maintenir ces informations à jour pour éviter tout problème lors du processus de commande.',
  privacy_section_data_title: 'Collecte de données',
  privacy_section_data_body: 'L\'application de livraison de nourriture collecte des données essentielles pour améliorer votre expérience, notamment votre localisation, l\'historique de vos commandes et vos préférences.',
  privacy_section_modifications_title: 'Modifications de commande',
  privacy_section_modifications_body: 'Vous pouvez modifier ou annuler vos commandes via l\'application avant qu\'elles ne soient traitées. Une fois une commande confirmée, les modifications peuvent ne pas être possibles.',
  privacy_section_payment_title: 'Sécurité des paiements',
  privacy_section_payment_body: 'Nous accordons la priorité à la sécurité de vos informations de paiement. Toutes les transactions effectuées via l\'application sont traitées à l\'aide d\'une technologie de chiffrement standard.',
