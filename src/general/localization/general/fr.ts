const fr = {
  ...
  promotional_banner_skip: 'Passer',
  ...
  profile_membership_lifetime_points: 'Points cumulés',
  profile_membership_reward_multiplier: 'récompenses',
  profile_membership_next_tier: '{{points}} points avant {{name}}',
  profile_membership_top_tier: 'Vous avez atteint le niveau le plus élevé',
