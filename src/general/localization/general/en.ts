const en = {
  ...
  profile_membership_lifetime_points: 'Lifetime points',
  profile_membership_reward_multiplier: 'rewards',
  profile_membership_next_tier: '{{points}} points to {{name}}',
  profile_membership_top_tier: 'You reached the highest tier',
