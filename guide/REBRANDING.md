...
## Client Identity
CLIENT_NAME= fixright
CLIENT_BRANCH=rebranding/fixright (already on this branch no need to create new)
APP_DISPLAY_NAME=Fix Right
EXPO_SLUG=fixright
IOS_BUNDLE_IDENTIFIER=com.fixright.app
ANDROID_PACKAGE_NAME=com.fixright.app

## Expo Project
EXPO_PROJECT_ID=92dce786-b859-4a46-be60-67ccd321122f
EXPO_UPDATES_URL=https://u.expo.dev/92dce786-b859-4a46-be60-67ccd321122f
EXPO_PUBLIC_EAS_PROJECT_ID=92dce786-b859-4a46-be60-67ccd321122f

## Backend and Socket URLs
EXPO_PUBLIC_API_BASE_URL=https://fixrightapi.duckdns.org
EXPO_PUBLIC_SOCKET_URL=https://fixrightapi.duckdns.org
EXPO_PUBLIC_HOME_SERVICES_SOCKET_URL=https://fixrightapi.duckdns.org/home-services
...
EXPO_PUBLIC_IOS_URL_SCHEME=com.fixright.app
...
## Legal and Business
SUPPORT_EMAIL= mansoor.fixright@gmail.com
BUSINESS_ADDRESS= mansoor.fixright@gmail.com
...
## Files Provided
ANDROID_GOOGLE_SERVICES_JSON_PATH=/google-services.json
IOS_GOOGLE_SERVICE_INFO_PLIST_PATH=/GoogleService-Info.plist
ICON_PATH=/assets/icon.png
ADAPTIVE_ICON_PATH=/adaptive-icon.png
SPLASH_ICON_PATH=/splash-icon.png
